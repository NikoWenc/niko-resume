    ...
    >
      ...
      <div className="flex flex-col flex-grow">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="font-label text-xs font-medium text-outline">{project.year}</span>
        </div>
    ...
    <section className="py-32 bg-surface" id="Projects">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20 text-center">
          <span className="font-label text-xs font-bold tracking-[0.2em] text-outline uppercase mb-4 block">Selected Works</span>
          <h2 className="font-headline text-4xl md:text-5xl font-bold text-primary tracking-tight">Curated Projects.</h2>
        </div>
