...
const Contact = () => {
  return (
    <section className="py-32 bg-surface-container-low border-t border-outline-variant/30" id="Contact">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <span className="font-label text-xs font-bold tracking-[0.2em] text-outline uppercase mb-8 block">Inquiries</span>
    ...
    <footer className="bg-surface border-t border-outline-variant/30 py-16">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="text-center md:text-left">
          <p className="font-label text-xs font-bold tracking-[0.2em] text-primary uppercase mb-2">Portfolio</p>
          <p className="text-on-surface-variant text-sm">© 2024 Portfolio. All rights reserved.</p>
        </div>
        ...
        <div className="text-center md:text-right">
          <p className="text-on-surface-variant text-sm font-label italic">{footerContent.quote}</p>
        </div>
      </div>
    </footer>
  );
